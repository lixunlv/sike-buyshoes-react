	...
	var Product = (function (_React$Component) {
	    ...
	    _createClass(Product, [{
	        ...
	        value: function render() {
	            ...
	            if (_data2.default.cartItems[id]) {
	                var cartItem = {
	                    name: name,
	                    imagePath: imagePath,
	                    price: price,
	                    quantity: _data2.default.cartItems[id]['quantity']
	                };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cart = (function (_React$Component) {
	    ...
	    _createClass(Cart, [{
	        ...
	        key: 'render',
	        value: function render() {
	            var children = Object.keys(_data2.default.cartItems).map(function (key) {
	                var item = _data2.default.cartItems[key];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Checkout = (function (_React$Component) {
	    ...
	    _createClass(Checkout, [{
	        key: 'render',
	        value: function render() {
	            var total = Object.keys(_data2.default.cartItems).reduce(function (previousValue, key, index, array) {
	                var item = _data2.default.cartItems[key];
	                var p = _data2.default.products[item['id']];
